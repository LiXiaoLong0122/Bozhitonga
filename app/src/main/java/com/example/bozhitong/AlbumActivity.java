...
import com.example.bozhitong.photo.util.AlbumHelper;
import com.example.bozhitong.photo.util.Bimp;
import com.example.bozhitong.photo.util.ImageBucket;
...
//			cancel.setText(Res.getString("finish")+"(" + Bimp.tempSelectBitmap.size() + "/"+PublicWay.num+")");
//			intent.setClass(mContext, ComplaintAndAdvocacy.class);
//			startActivity(intent);
			finish();
		}
