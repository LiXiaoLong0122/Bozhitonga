...
import com.example.bozhitong.camera.CameraManager;
import com.example.bozhitong.decoding.CaptureActivityHandler;
import com.example.bozhitong.decoding.InactivityTimer;
import com.example.bozhitong.decoding.RGBLuminanceSource;
import com.example.bozhitong.view.ViewfinderView;
...
//		playBeepSoundAndVibrate();
		...
		if (resultString.equals("")) {
			Toast.makeText(MipcaActivityCapture.this, "���ȣ���ɨ�Ķ�ά�뻵��", Toast.LENGTH_SHORT).show();
		}else {
