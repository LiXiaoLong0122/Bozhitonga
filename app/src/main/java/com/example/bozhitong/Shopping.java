...
import com.example.bozhitong.fragment.CommoditypriceFragment;
import com.example.bozhitong.fragment.DefaultsortFragment;
import com.example.bozhitong.fragment.SalesispreferredFragment;
import com.example.bozhitong.fragment.adapter.ShoppingPagerAdapter;
import com.example.bozhitong.utils.Tools;

import java.util.ArrayList;
import java.util.List;

public class Shopping extends FragmentActivity implements OnCheckedChangeListener {
	...
	private void initData() {
		beans.clear();  
		beans.add(new DefaultsortFragment());
		beans.add(new SalesispreferredFragment());
		beans.add(new CommoditypriceFragment());
	...
	private void initView() {
      ...
      mBack.setOnClickListener(new OnClickListener() {
		...
		adapter = new ShoppingPagerAdapter(getSupportFragmentManager());
		...
		pager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				...
				if(position==0){
					 button =(RadioButton) findViewById(R.id.tv_Defaultsort);
				}else if(position==1){
					 button =(RadioButton) findViewById(R.id.tv_Salesispreferred);
				}else if(position==2){
					 button =(RadioButton) findViewById(R.id.tv_commodityprice);
				}
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		case R.id.tv_Defaultsort:
			...
			break;
		case R.id.tv_Salesispreferred:
			pager.setCurrentItem(1);
			break;
		case R.id.tv_commodityprice:
